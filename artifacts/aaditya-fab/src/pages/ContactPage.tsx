...
export default function ContactPage() {
  ...
  const onSubmit = (data: FormValues) => {
    const payload: InquiryInput = {
      ...
      requiredCapacity:
        isCrane && data.requiredCapacity
          ? Number(data.requiredCapacity)
          : undefined,
      spanMeters:
        isCrane && data.spanMeters ? Number(data.spanMeters) : undefined,
      shedDimensions:
        isShed && data.shedDimensions ? data.shedDimensions : undefined,
      existingEquipment:
        isRework && data.existingEquipment ? data.existingEquipment : undefined,
    };
      ...
      <section className="steel-gradient text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-white/70 text-lg max-w-2xl">
            Tell us your requirements — we'll send a detailed technical quote
            within 24 hours.
          </p>
        </div>
      </section>
            ...
            <div className="space-y-5">
              ...
              <div className="bg-accent/10 border border-accent/20 rounded-lg p-4">
                ...
                <p className="text-xs text-muted-foreground">
                  All enquiries receive a detailed technical quote within 24
                  business hours.
                </p>
              </div>
            </div>
              ...
              >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 bg-muted/40 rounded-lg border border-border">
                    <div>
                      ...
                      <Input
                        ...
                        {...form.register("requiredCapacity")}
                      />
                    </div>
                    <div>
                      <Label
                ...
                {isShed && (
                  <div className="p-4 bg-muted/40 rounded-lg border border-border">
                    <Label
                      htmlFor="shedDimensions"
                      className="text-sm font-medium"
                    >
                      Shed Dimensions (L x W x H in metres)
                    </Label>
                    <Input
                      id="shedDimensions"
                      placeholder="e.g. 30x15x8"
                      className="mt-1"
                      data-testid="input-dimensions"
                      {...form.register("shedDimensions")}
                    />
                ...
                {isRework && (
                  <div className="p-4 bg-muted/40 rounded-lg border border-border">
                    <Label
                      htmlFor="existingEquipment"
                      className="text-sm font-medium"
                    >
                      Existing Equipment Make & Age
                    </Label>
                    <Input
                      id="existingEquipment"
                      placeholder="e.g. Indef 10T crane, 15 years old"
                      className="mt-1"
                      data-testid="input-equipment"
                      {...form.register("existingEquipment")}
                    />
                  </div>
                )}
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    rows={4}
                    className="mt-1"
                    placeholder="Any additional requirements, site conditions, or specifications..."
